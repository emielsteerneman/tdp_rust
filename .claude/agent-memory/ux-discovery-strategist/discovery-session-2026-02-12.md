...
The user (emiel) is both the builder and a primary user (Small Size League competitor).
...
## Success Criteria (User's Own Words)
...
5. Team Profiles (defer, no validated demand)
